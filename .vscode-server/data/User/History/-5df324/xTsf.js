          ...
          .then((res) => {
            ...
            const mailOptions = {
              ...
              function distance(lat1, lon1, lat2, lon2, unit) {
                ...
                console.log("DISTANCIA: "+distance(latAgresor,lonAgresor,latVictima,lonVictima,"M"));
              if(distance(latAgresor,lonAgresor,latVictima,lonVictima,"M")<=distanciaProhibida){ 
              transporter.sendMail(mailOptions, (error, data) => {
              if (error) {
                console.log(error)
              ...
              console.log("Correo enviado2");
                ...
                console.log("DISTANCIA MAYOR A LA RESTIDA:"+distance(latAgresor,lonAgresor,latVictima,lonVictima,"M"));
